...
Please download cat_and_weight.ipynb, the dta data file from the link in the noebook and go through the instructions. To see the outcome look at OUTPUT_cat_and_weight.ibynb.
